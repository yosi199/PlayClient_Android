...
public interface CloudAPI {
     ...
     * @throws java.io.IOException                               In case of network/server errors
     */
     ...
     * @throws SoundCloud.CloudAPI.BrokenHttpClientException in case of HTTPClient framework bugs
     */
     ...
     * @return the id
     * @throws java.io.IOException                   network errors
     * @throws SoundCloud.CloudAPI.ResolverException if object could not be resolved
     */
     ...
     * @see SoundCloud.CloudAPI#authorizationCode(String, String...)
     */
